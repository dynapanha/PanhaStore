...
namespace POS {
    ...
    public class MartReport : ReportClass {
    ...
    public class CachedMartReport : Component, ICachedReport {
        
        public CachedMartReport() {
        }
